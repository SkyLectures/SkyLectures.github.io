...
- 텍스트 생성 실습
    - GPT-3.5 Turbo를 활용한 간단한 텍스트 생성 실습<br><br>
...
- [클라우드 플랫폼 개요](/materials/S04-01-01-01_01-CloudPlatformOverview)

- [GCP(구글 클라우드 플랫폼) 개요](/materials/S04-02-01-01_01-GcpOverview) <span style="color: orange;">→ 검토 대기</span>
- GCP 환경 설정
    - GCP 계정 생성 및 프로젝트 설정
    - VM 인스턴스 생성 및 SSH 접속
...
- Flask 기본 기능 구현
    ...
    - [템플릿 엔진(Jinja2) 활용](/material/S01-04-03-02_03-TemplateEngineJinja2)
