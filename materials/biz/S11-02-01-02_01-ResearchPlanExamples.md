...
- 1개월이 소요되던 번역작업이 48시간 내로 단축되었고, 긴급한 경우 2시간 이내 처리도 가능해짐
- 현재 월 300만 단어 이상을 처리하고 있으며, 영어, 스페인어, 소말리어 등 다양한 언어를 지원함
...
- 그 결과, 의사들이 환자 기록을 분석하고 누락된 검사를 찾는 시간이 몇 주에서 5분으로 줄었으며, AI를 사용하는 의사들은 그렇지 않은 의사들보다 4배 더 많은 누락된 검사를 발견하였고, 검사실 결과, 영상 검사, 생검 결과 등을 더 정확하게 파악할 수 있게 되었음
...
- 이에 AI가 계약서를 자동으로 읽고 분석하는 시스템을 구축하였고, 2주가 걸리던 일이 2시간 만에 끝낼 수 있게 됨
