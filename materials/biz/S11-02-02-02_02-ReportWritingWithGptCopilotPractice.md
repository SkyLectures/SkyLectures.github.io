...
- **[시나리오]**
    - '라즈베리파이 기반 엣지 AI 자율주행 세그멘테이션 모델 상용화 추진 보고서.docx'라는 워드 문서 초안을 가지고 있음
...
- **[PowerPoint Copilot 예시 1: 워드 문서 기반 프레젠테이션 개요 생성]**
    ...
    ```
    이 프레젠테이션에 대한 개요를 [라즈베리파이 기반 엣지 AI 자율주행 세그멘테이션 모델 상용화 추진 보고서.docx] 문서를 
    기반으로 8개의 슬라이드로 작성해 줘.
...
- **[Word Copilot 예시 1: '분석 및 대안' 섹션 초안 작성 (현재 문서 및 외부 파일 참조)]**
    ...
    - **현재 상태**
        ...
        - `/기술보고서_엣지AI_분석.docx` 및 `/시장_경쟁사_분석.xlsx` 파일이 존재함
