...
<table>
    <thead>
        <th style="width: 150px;">명령어</th>
        <th style="width: 200px;">명령어 종류</th>
        <th style="width: 200px;">삭제 대상/th>
    ...
    <tbody>
        <tr>
            ...
            <td class="td-left">DDL</td>
            <td class="td-left">테이블 구조 + 데이터 전체 삭제</td>
            <td class="td-left">X (완전 소멸)</td>
            <td class="td-left">불가능</td>
        </tr>
        <tr>
            <td class="td-rowheader">TRUNCATE</td>
            <td class="td-left">DDL</td>
            <td class="td-left">데이터 전체만 삭제 (초기화)</td>
            <td class="td-left">O</td>
            <td class="td-left"불가능</td>
        </tr>
        <tr>
            <td class="td-rowheader">DELETE</td>
            <td class="td-left">DML</td>
            <td class="td-left">조건에 맞는 데이터 행(Row) 삭제</td>
            <td class="td-left">O</td>
            <td class="td-left">가능 (트랜잭션 복구 가능)</td>
        </tr>
    </tbody>    
</table>
</div>
