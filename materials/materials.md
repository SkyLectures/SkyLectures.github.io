...
- FastAPI 기초
    - 서비스 기본 흐름
    - 서비스 구현
    - 비동기 처리와 Pydantic 모델링
- FastAPI 응용
    - LLM Streaming API 구현
</div>
</div>
...
- Spark+Iceberg+MinIO 연결 및<br>대용량 데이터 분석 준비
- Spark DataFrame, SparkSQ을 이용한<br>데이터 가공
- 파티셔닝과 셔플링 최적화 이해하기
</div>
</div>
...
<div class="split-content">
<div class="split-content-element" markdown="1">
<span class="split-content-title">Streamit를 활용한 LLM 연동 어플리케이션</span>
- 가이드라인
- Streamlit 기반의 챗봇 인터페이스 개발
</div>
<div class="split-content-element" markdown="1">
<span class="split-content-title">LangChain, Vector DB를 활용한 어플리케이션 구현</span>
- 가이드라인
</div>
</div>
