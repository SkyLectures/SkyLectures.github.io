...
permalink: /material/python/S01-01-04-03_01-Pandas
...
- 상관관계와 공분산
    ...
    ```python
    price = pd.read_pickle('https://raw.githubusercontent.com/aidalabs/Lectures/master/LectureFiles/datasets/S01-01-04-03_01-YahooPrice.pkl')      # 야후 금융사이트에서 구한 주식 가격
    price
    ```

    ```python
    volume = pd.read_pickle('https://raw.githubusercontent.com/aidalabs/Lectures/master/LectureFiles/datasets/S01-01-04-03_01-YahooVolume.pkl')      # 야후 금융사이트에서 구한 시가 총액
    volume
    ```
